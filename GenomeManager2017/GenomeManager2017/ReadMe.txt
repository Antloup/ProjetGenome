================================================================================
    BIBLIOTHÈQUE MFC (MICROSOFT FOUNDATION CLASS) : Vue d'ensemble du projet GenomeManager2017
===============================================================================

L'Assistant Application a créé cette application GenomeManager2017 pour vous. Cette application décrit non seulement les bases de l'utilisation de Microsoft Foundation Classes, mais est également un point de départ pour l'écriture de votre application.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application GenomeManager2017.

GenomeManager2017.vcxproj
...
GenomeManager2017.vcxproj.filters
...
GenomeManager2017.h
    ...
    Il comprend d'autres en-têtes spécifiques au projet (notamment Resource.h) et déclare la classe d'application CGenomeManager2017App.

GenomeManager2017.cpp
    Il s'agit du fichier source principal de l'application qui contient la classe d'application CGenomeManager2017App.

GenomeManager2017.rc
...
res\GenomeManager2017.ico
    Il s'agit d'un fichier icône, qui est utilisé comme icône de l'application. Cette icône est incluse par le fichier de ressources principal GenomeManager2017.rc.

res\GenomeManager2017.rc2
...
GenomeManager2017Dlg.h, GenomeManager2017Dlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CGenomeManager2017Dlg. Cette classe définit le comportement de la boîte de dialogue principale de votre application. Le modèle de la boîte de dialogue se trouve dans GenomeManager2017.rc, qui peut être modifié dans Microsoft Visual C++.
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) GenomeManager2017.pch et un fichier de type précompilé nommé StdAfx.obj.
